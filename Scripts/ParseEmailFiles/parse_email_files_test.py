...
def test_email_raw_headers(mocker):
    ...
    assert len(results) == 1
    assert results[0]['Type'] == entryTypes['note']
    assert results[0]['EntryContext']['Email']['From'] == 'email@domain.com'
    assert results[0]['EntryContext']['Email']['To'] == 'email@domain.com, example1@example.com'
    assert results[0]['EntryContext']['Email']['CC'] == 'email@domain.com, example1@example.com'
    assert results[0]['EntryContext']['Email']['HeadersMap']['From'] == 'Guy Test <email@domain.com>'
    assert results[0]['EntryContext']['Email']['HeadersMap']['To'] == 'Guy Test <email@domain.com>, Guy Test1 <example1@example.com>'
    assert results[0]['EntryContext']['Email']['HeadersMap']['CC'] == 'Guy Test <email@domain.com>, Guy Test1 <example1@example.com>'
