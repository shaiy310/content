...
def test_email_raw_headers(mocker):
    ...
    assert results[0]['EntryContext']['Email']['HeadersMap']['To'] == 'Guy Test <email@domain.com>' \
                                                                      ', Guy Test1 <example1@example.com>'
    assert results[0]['EntryContext']['Email']['HeadersMap']['CC'] == 'Guy Test <email@domain.com>, ' \
                                                                      'Guy Test1 <example1@example.com>'
